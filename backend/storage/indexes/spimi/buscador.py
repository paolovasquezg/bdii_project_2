import json
import math
from procesador_texto import cargar_lista_parada, preprocesar_texto, LEMATIZADOR_ES
...
class BuscadorSPIMI:
    ...
    def __init__(self, nombre_tabla_indice):
        ...
        self.archivo_indice_final = f"{nombre_tabla_indice}_indice_final.jsonl"
        self.archivo_lexicon = f"{nombre_tabla_indice}_lexicon.json"
        self.archivo_idf = f"{nombre_tabla_indice}_idf.json"
        self.archivo_normas = f"{nombre_tabla_indice}_normas.json"
