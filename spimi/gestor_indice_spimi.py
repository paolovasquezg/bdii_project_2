...
import heapq
import glob
from spimi.procesador_texto import cargar_lista_parada, preprocesar_texto
...
def finalizar_indice_spimi(nombre_tabla_indice):
    ...
    directorio_temporal = f"{nombre_tabla_indice}"
    archivo_indice_final = f"{nombre_tabla_indice}indice_final.jsonl"
    archivo_metadatos = f"{nombre_tabla_indice}metadatos.json"
    ...
    archivo_lexicon = f"{nombre_tabla_indice}lexicon.json"
    archivo_idf = f"{nombre_tabla_indice}idf.json"
    archivo_normas = f"{nombre_tabla_indice}normas.json"
